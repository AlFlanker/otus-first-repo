...
import com.gmail.alexflanker89.lesson1.dao.UserAnswerDaoSimple;
...
import com.gmail.alexflanker89.lesson1.service.SimpleUserAnswerService;
...
public class UserAnswerServiceTest {
    ...
    @BeforeEach
    public void load(){
         questionDaoSimple = new QuestionDaoSimple(Paths.get("src/main/resources/lesson1/question.csv"));
